...
class SumitKumar:
    def __init__(self):
        ...
        self.university   = "DCRUST, Murthal"
        self.degree       = "B.Tech Computer Science & Engineering"
        self.gpa          = "7.8 / 10"
        self.graduation   = "June 2027"
        self.email        = "mk1052078@gmail.com"
        self.linkedin     = "linkedin.com/in/sumit-kumar1311"

    def current_focus(self):
        return [
            "🔐 Web Application Security & Penetration Testing",
            "🤖 RAG Systems & LLM-based Applications",
            "🛡️  WAF Development & OWASP Top 10",
            "⚙️  FastAPI Backend & REST API Development",
            "🌐 Network Security & Vulnerability Assessment"
        ]

    def ask_me_about(self):
        return ["Cybersecurity", "Ethical Hacking", "AI/ML", "React", "Python"]
```
